...
echo "Running stack external stack deploy test"
...
$TEST_TARGET_SO_STACK setup init --output $test_deployment_spec --config BPI_TEST_PARAM_1=PASSED,BPI_TEST_PARAM_3=FAST
...
$TEST_TARGET_SO_STACK setup create --spec-file $test_deployment_spec --deployment-dir $test_deployment_dir
