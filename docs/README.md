...
| [k8s-deployment-enhancements.md](k8s-deployment-enhancements.md) | Controlling Kubernetes pod placement with node affinity rules, and which container runtime (e.g. kata) a pod runs under. |
